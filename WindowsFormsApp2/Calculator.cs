...
namespace Calculator
{
    public partial class Calculator : Form
    {
        ...
        private void EqualsButton_Click(object sender, MouseEventArgs e)
        {
            label1.Text = Convert.ToString(Numbers(TextBox.Text));
            TextBox.Clear();
        }
        ...
        private void OneButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "1";
        }
        private void TwoButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "2";
        }
        private void ThreeButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "3";
        }
        private void FourButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "4";
        }
        private void FiveButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "5";
        }
        private void SixButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "6";
        }
        private void SevenButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "7";
        }
        private void EightButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "8";
        }
        private void NineButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "9";
        }
        ...
        private void ZeroButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "0";
        }
        ...
        private void MultiplyButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "*";
        }
        private void DevideButton_Click(object sender, MouseEventArgs e)
        {
            TextBox.Text += "/";
        }
        ...
        private void ScobkaButton_Click(object sender, EventArgs e)
        {
            TextBox.Text += "(";
        }

        private void ScobkaButton2_Click(object sender, EventArgs e)
        {
            TextBox.Text += ")";
        }
    }
